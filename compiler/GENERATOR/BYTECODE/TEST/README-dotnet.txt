...
5. The debug information generated by the BETA compiler is still 
   somewhat rudimentary. Some functions may not be
   possible to step into using DbgCLR or Visual Studio.NET (see
   below), for instance.

6. Local variables in classes corresponding to BETA patterns are
...
8. The compiler is somewhat noisy. This is partly caused by IlAsm.exe
