...
\note{display - currently ignored. Terminology: global versus
local and nested patterns}
...
\note{More explanation here regarding Q.get?}
...
{\tt A.display} executes {\tt display} as defined in {\tt
AccountBuffer}. This results in execution of the {\tt do}-part of {\tt
Buffer.display} followed by execution of the {\tt do}-part of {\tt
AccountBuffer.display} in accordance with the BETA semantics of method
...
variable {\tt succ} and an extension of {\tt insert}.
...
The extension of the virtual {\tt insert} is supposed to append the
