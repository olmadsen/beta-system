...
\item Figure (b) shows the situation where the first {\tt A.call()} in
  ...
  label {\tt A:} just before {\tt suspend} in this first invocation of
  {\tt compute}.
...
\item Figure (d) shows the situation where the {\tt M.call()} after
  the label {\tt L0:} has been executed by {\tt merger}. This implies
  an execution of {\tt M} leading to a similar situation for {\tt M}
  as the one described for {\tt A} in (b).
\item Figure (e) shows the situation at {\tt L2:} in {\tt merger} where
