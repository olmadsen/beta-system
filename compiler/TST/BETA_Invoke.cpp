...
extern "C" 
{
   ...
   *   hr = BETA_Invoke(pdisp, DISPATCH_METHOD, NULL, NULL, NULL, OLESTR("method1"), 
   ...
   *   V_R8(&v) = 12345.6789; 
   *   VariantInit(&v2);
   *   hr = BETA_Invoke(pdisp, DISPATCH_METHOD, NULL, NULL, NULL, OLESTR("method2"), 
   *         TEXT("v&v"), v, (VARIANT FAR*)&v2);
   */
  HRESULT 
    BETA_Invoke(LPDISPATCH pdisp, 
	   WORD wFlags,
	   LPVARIANT pvRet,
   ...
   */
  void ErrorMessage2(const char* str, HRESULT hr)
      ...
      if (pMsgBuf)
	{
	  ...
	  msg = (char*) malloc(strlen(str)+strlen((char*)pMsgBuf) + 2);
	  msg[0] = '\0';
	  lstrcat(msg,str);
	  lstrcat(msg,"\n");
	  lstrcat(msg,(char*)pMsgBuf);
	  
	  MessageBox(NULL,msg,"Error.",MB_OK | MB_SETFOREGROUND );
