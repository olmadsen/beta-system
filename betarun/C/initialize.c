...
#define DEMOHEADERLEN 46
#define DEMOHEADERCHK 3660
/* The following data was created using C/scramble.c with template
#define SCRAMBLETEMPLATE "\
This program was constructed using a DEMO version \
...
*/
#define DEMOSTRING {\
0x7d, 0x3e, 0x80, 0x1c, 0x65, 0x3e, 0x75, 0x43, 0x4d, 0x68, \
0x32, 0x88, 0xd1, 0xcf, 0xd7, 0xcd, 0x16, 0x9e, 0x1a, 0x9d, \
0x17, 0x8c, 0x27, 0x7b, 0x41, 0x5e, 0x64, 0x29, 0x32, 0x70, \
0x2c, 0x6e, 0x29, 0x77, 0x80, 0x0a, 0x53, 0x40, 0x2e, 0x8c, \
0xec, 0xf5, 0xac, 0xf2, 0xa9, 0x03, 0x93, 0x25, 0x74, 0x7d, \
0x3b, 0x86, 0xcf, 0xe4, 0xb5, 0xf9, 0x02, 0x78, 0x3b, 0xad, \
0xea, 0xad, 0xf1, 0xac, 0xb5, 0x20, 0x8e, 0x03, 0x6b, 0x74, \
0x50, 0x52, 0x4a, 0x67, 0x2b, 0x6f, 0x78, 0x42, 0x55, 0x5a, \
0xa3, 0xf7, 0xbf, 0xef, 0xf8, 0xc0, 0xd7, 0xe4, 0xc6, 0x0f, \
0x96, 0x1c, 0x65, 0x39, 0x73, 0x3f, 0x84, 0xcd, 0xd4, 0xe4, \
0xbf, 0xc8, 0xd6, 0xc9, 0xd1, 0xe6, 0xbc, 0x06, 0x9b, 0x1b, \
0x9d, 0x1c, 0x65, 0x3e, 0x74, 0x2f, 0x88, 0x10, 0x8c, 0x12, \
0x8a, 0xd3, 0xdb, 0xde, 0xe3, 0xec, 0xab, 0xed, 0xc2, 0x0b, \
0x96, 0x22, 0x79, 0x82, 0x0c, 0x8b, 0x1b, 0x64, 0x39, 0x85, \
0x0d, 0x97, 0x28, 0x6a, 0x2d, 0x73, 0x7c, 0x3c, 0x77, 0x80, \
0x0c, 0x8c, 0x0a, 0x90, 0x1e, 0x95, 0x1f, 0x9f, 0x27, 0x74, \
0x7d, 0x36, 0x6c, 0x47, 0x60, 0x38, 0x74, 0x3a, 0x72, 0x85, \
0xce, 0xc4, 0xe0, 0xae, 0xb7, 0x01, 0x90, 0xd9, 0xd6, 0xe7, \
0xab, 0xb4, 0xed, 0xc8, 0xd0, 0xe0, 0xbb, 0x03, 0x97, 0xe0, \
0xb2, 0xea, 0xf3, 0xa9, 0x05, 0x90, 0x23, 0x6f, 0x35, 0x6a, \
0x73, 0x30, 0x88, 0xd1, 0xce, 0xcf, 0xd3, 0x1c, 0x97, 0x1b, \
0x91, 0x0e, 0xa5, 0xf5, 0xbf, 0xf4, 0xc6, 0xd2, 0xe5, 0xbf, \
0xc8, 0xca, 0xcd, 0x16, 0x8b, 0x0c, 0x92, 0xdb, 0xe8, 0xb6, \
0x04, 0x94, 0xdd, 0xda, 0xdc, 0xe8, 0xb6, 0x01, 0x9b, 0x27, \
0x32 }
#define DEMOLEN 241
#define DEMOCHK 22545
#else
/* The following data was created using C/scramble.c with template
#define TEMPLATE "\n\
  ******************************************************\n\
...
/* The following data was created using C/scramble.c with template
#define TEMPLATE "\r\
Note: This program was compiled using a Personal Edition of the\r\
Mj\277lner BETA System and may not be used for commercial purposes\r\
\r"
*/
#define PESTRING {\
0x36, 0xa1, 0xf7, 0xac, 0xf2, 0xf1, 0xfa, 0xd7, 0xe8, 0xaa, \
0x02, 0x4b, 0x64, 0x3f, 0x79, 0x47, 0x5e, 0x68, 0x2e, 0x37, \
0x69, 0x31, 0x6b, 0x74, 0x40, 0x58, 0x5e, 0x57, 0x67, 0x34, \
0x7a, 0x47, 0x90, 0x0e, 0xa6, 0xf8, 0xbf, 0x01, 0x4a, 0x54, \
0x9d, 0xf6, 0xbc, 0xf7, 0xad, 0xeb, 0xae, 0xf8, 0xbd, 0xc6, \
0xac, 0xf1, 0xc1, 0xde, 0xe0, 0xb8, 0xff, 0x08, 0x90, 0x1f, \
0x68, 0x45, 0x56, 0x5c, 0x7a, 0x60, 0x33, 0xb5, 0x02, 0x95, \
0x19, 0x94, 0xdd, 0xc8, 0xb6, 0x0b, 0x73, 0x7c, 0x58, 0x4a, \
0x62, 0x3f, 0x83, 0x17, 0x60, 0x2a, 0x6d, 0x32, 0x3b, 0x7f, \
0x47, 0x67, 0x70, 0x47, 0x51, 0x4e, 0x97, 0x1e, 0xa4, 0xad, \
0x01, 0x9b, 0x27, 0x6c, 0x75, 0x3c, 0x7c, 0x37, 0x40, 0x4c, \
0x4c, 0x4a, 0x50, 0x5e, 0x55, 0x5f, 0x5f, 0x67, 0x34, 0x3d, \
0x76, 0x2c, 0x87, 0x20, 0x78, 0x34, 0x7a, 0x32, 0x68, 0x8e }
#define PELEN 130
#define PECHK 11836
#else
/* The following data was created using C/scramble.c with template
...
void Initialize()
{
...
#ifdef DEMO
  {
    ...
    p = unscrambleString(peHeaderMessage,DEMOHEADERLEN, DEMOHEADERCHK);
    q = unscrambleString(peMessage,DEMOLEN, DEMOCHK);
    CPrompt(p,q,"","");
    FREE(p);
    FREE(q);
#else
