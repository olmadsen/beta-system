...
*/
    ...
    scanf("%f",param);
    for(i=0; i<1000; i++) {
      *(array+i) = genchi(*param);
      printf(" %15.7g",*(array+i)); if (i%5==0) printf("\n");
    };
    printf("\n");
...
*/
    ...
    for(i=0; i<1000; i++) {
      *(array+i) = gennf(*param,*(param+1),*(param+2));
      printf(" %15.7g",*(array+i)); if (i%5==0) printf("\n");
    };
    printf("\n");
    statistics(array,1000L,&av,&var,&xmin,&xmax);
...
*/
    ...
    scanf("%f%f",param,(param+1));
    for(i=1; i<=1000; i++) {
      *(array+i-1) = genunf(*param,*(param+1));
      printf(" %15.7g",*(array+i-1)); if (i%5==0) printf("\n");
    };
    printf("\n");
    statistics(array,1000L,&av,&var,&xmin,&xmax);
    trstatistics(pr_type,param,&avtr,&vartr);
...
*/
    ...
    scanf("%f%f",param,(param+1));
    for(i=1; i<=1000; i++) {
      *(array+i-1) = genbet(*param,*(param+1));
      printf(" %15.7g",*(array+i-1)); if (i%5==0) printf("\n");
    };
    printf("\n");
    statistics(array,1000L,&av,&var,&xmin,&xmax);
...
*/
    ...
    scanf("%d%f",&ntry,&pevt);
    for(i=1; i<=1000; i++) {
      *(iarray+i-1) = ignbin(ntry,pevt);
      printf(" %7i",*(iarray+i-1)); if (i%5==0) printf("\n");
    };
    printf("\n");
