 ...
 L41:
	...
	-- Module:gen: 
	-- Module:gen: 
	-- ModuleItem:gen Program2
	-- ConsRef:gen: Program2
	-- ObjectGenerator:gen: super: :singular:staticOff: 2
	pushThis 
	invoke 3 2 Program2
	rpop
 ...
 L67:
	...
	-- VarRef:gen: tern
	-- ConsRef:gen: antall
	-- ObjectGenerator:gen: super: Array(6):IS-empty: staticOff: 3
 ...
 L68:
	...
	rpop
	-- ObjectGenerator:gen: super: tern := Terning:IS-empty: staticOff: 0
	-- Invocation:gen: tern := Terning
	-- Invocation:loadOrigin: tern := Terning
	...
	-- on : 0
	-- AdjustOrigin: 0
	-- Invocation:loadOrigin:scan: := Terning
	-- Binary:loadArgs: 
	-- pattern:loadArgs: := V: ? Object:= Terning
	-- ObjectGenerator:gen: super: Terning:IS-empty: staticOff: 0
	-- Invocation:gen: Terning
	-- Invocation:loadOrigin: Terning
	-- Invocation:loadOrigin:scan: Terning
	-- Unary:pushThis: 
	pushThis 
	-- Unary:loadOrigin: Terning
	-- on : 0
	-- AdjustOrigin: 0
	-- Unary:loadArgs: 
	-- pattern:loadArgs: TerningTerning
	-- Unary:invoke: 
	-- pattern:invoke: Terning
    ...
    tern.kast
    antall.put(tern.eyes) := antall.get(tern.eyes) + 1:IS-empty: staticOff: 0
	pushThis 
	invoke 131 0 %for%to%%do%#S#131
	rpop
	-- ObjectGenerator:gen: super: %for 1 %to% 6 %do% 
 ...
 L119:
    ...
    tern.kast
    antall.put(tern.eyes) := antall.get(tern.eyes) + 1
 ...
 L159:
	...
	-- on : 2
	-- AdjustOrigin: 0
	rpushg 2 body#S#161:origin
	rpushg 2 %for%to%%do%#S#131:origin
	...
	invoke 129 0 kast
	rpop
	-- ObjectGenerator:gen: super: antall.put(tern.eyes) := antall.get(tern.eyes) + 1:IS-empty: staticOff: 0
	-- Invocation:gen: antall.put(tern.eyes) := antall.get(tern.eyes) + 1
	-- Invocation:loadOrigin: antall.put(tern.eyes) := antall.get(tern.eyes) + 1
	-- Invocation:loadOrigin:scan: antall
	-- Unary:pushThis: 
	pushThis 
	-- Unary:loadOrigin: antall
	...
	rpushg 2 body#S#161:origin
	rpushg 2 %for%to%%do%#S#131:origin
	-- next not assign: put(tern.eyes) :E: antall
	-- Unary:loadArgs: 
	-- ConsRef:loadArgs: 
	-- Unary:invoke: 
	-- ConsRef:invoke: antall
	rpushg 3 antall
	-- Invocation:loadOrigin:scan: put(tern.eyes)
	-- next not assign: := antall.get(tern.eyes) + 1 :E: put(tern.eyes)
	-- Function:loadArgs: 
	-- pattern:loadArgs: put(ix: ? integer)put(tern.eyes)
	-- ObjectGenerator:gen: super: tern.eyes:IS-empty: staticOff: 0
	-- Invocation:gen: tern.eyes
	-- Invocation:loadOrigin: tern.eyes
	-- Invocation:loadOrigin:scan: tern
	-- Unary:pushThis: 
	pushThis 
	-- Unary:loadOrigin: tern
	...
	-- pattern:invoke: put(ix: ? integer)
	invoke 121 0 put
	-- Invocation:loadOrigin:scan: := antall.get(tern.eyes) + 1
	-- Binary:loadArgs: 
	-- pattern:loadArgs: := V: ? integer:= antall.get(tern.eyes) + 1
	-- ObjectGenerator:gen: super: antall.get(tern.eyes) + 1:IS-empty: staticOff: 0
	-- Invocation:gen: antall.get(tern.eyes) + 1
	-- Invocation:loadOrigin: antall.get(tern.eyes) + 1
	-- Invocation:loadOrigin:scan: antall
	-- Unary:pushThis: 
	pushThis 
	-- Unary:loadOrigin: antall
	...
	rpushg 2 body#S#161:origin
	rpushg 2 %for%to%%do%#S#131:origin
	-- next not assign: get(tern.eyes) :E: antall
	-- Unary:loadArgs: 
	-- ConsRef:loadArgs: 
	-- Unary:invoke: 
	-- ConsRef:invoke: antall
	rpushg 3 antall
	-- Invocation:loadOrigin:scan: get(tern.eyes)
	-- next not assign: + 1 :E: get(tern.eyes)
	-- Function:loadArgs: 
	-- pattern:loadArgs: get(ix: ? integer) -> res: ? integerget(tern.eyes)
	-- ObjectGenerator:gen: super: tern.eyes:IS-empty: staticOff: 0
	-- Invocation:gen: tern.eyes
	-- Invocation:loadOrigin: tern.eyes
	-- Invocation:loadOrigin:scan: tern
 ...
 L189:
	...
	-- on : 2
	-- AdjustOrigin: 0
	rpushg 2 thenPart#S#157:origin
 ...
 L191:
    ...
    mood := 0:IS-empty: staticOff: 0
	pushThis 
	invoke 159 0 %if%then%%else%#S#159
	rpop
 L192:
	rtnEventQ 0
	setThisStack 
 ...
 L214:
	...
	class %if%then%%else%#S#159 159 3
	rstore 3 origin
	allocEventQ
	-- super %if%then%%else%
	--  1:36 2:36 3:0 4:0
	...
	-- AdjustOrigin: 3
	rpushg 3 origin
	rpushg 2 elsePart#S#158:origin
	rpushg 3 %if%then%%else%#S#127:origin
	rpushg 1 tilfeldig:origin
	rpushg 1 Program2:origin
	rpushg 1 bmp:origin
 ...
 L228:
	...
	-- on : 4
	-- AdjustOrigin: 0
	rpushg 2 thenPart#S#164:origin
 ...
 L230:
    ...
    mood := 0:IS-empty: staticOff: 0
	pushThis 
	invoke 166 0 %if%then%%else%#S#166
	rpop
 L231:
	rtnEventQ 0
	setThisStack 
 ...
 L232:
	...
	-- on : 4
	-- AdjustOrigin: 0
	rpushg 2 thenPart#S#167:origin
	rpushg 3 %if%then%%else%#S#159:origin
	rpushg 2 elsePart#S#158:origin
	rpushg 3 %if%then%%else%#S#127:origin
 ...
 L234:
    ...
    mood := 0:IS-empty: staticOff: 0
	pushThis 
	invoke 169 0 %if%then%%else%#S#169
	rpop
 L235:
	rtnEventQ 0
	setThisStack 
 ...
 L239:
	...
	class %if%then%%else%#S#166 166 3
	rstore 3 origin
	allocEventQ
	-- super %if%then%%else%
	--  1:36 2:36 3:0 4:0
	...
	-- AdjustOrigin: 3
	rpushg 3 origin
	rpushg 2 elsePart#S#165:origin
	rpushg 3 %if%then%%else%#S#156:origin
	rpushg 2 elsePart#S#155:origin
	rpushg 3 %if%then%%else%#S#125:origin
	rpushg 1 tilfeldigx:origin
 ...
 L241:
	...
	class %if%then%%else%#S#169 169 3
	rstore 3 origin
	allocEventQ
	-- super %if%then%%else%
	--  1:36 2:36 3:0 4:0
	...
	-- AdjustOrigin: 3
	rpushg 3 origin
	rpushg 2 elsePart#S#168:origin
	rpushg 3 %if%then%%else%#S#159:origin
	rpushg 2 elsePart#S#158:origin
	rpushg 3 %if%then%%else%#S#127:origin
	rpushg 1 tilfeldig:origin
 ...
 L244:
	...
	-- on : 6
	-- AdjustOrigin: 0
	rpushg 2 thenPart#S#170:origin
	rpushg 3 %if%then%%else%#S#166:origin
	rpushg 2 elsePart#S#165:origin
	rpushg 3 %if%then%%else%#S#156:origin
	rpushg 2 elsePart#S#155:origin
	rpushg 3 %if%then%%else%#S#125:origin
 ...
 L248:
	...
	-- on : 6
	-- AdjustOrigin: 0
	rpushg 2 thenPart#S#173:origin
	rpushg 3 %if%then%%else%#S#169:origin
	rpushg 2 elsePart#S#168:origin
	rpushg 3 %if%then%%else%#S#159:origin
	rpushg 2 elsePart#S#158:origin
	rpushg 3 %if%then%%else%#S#127:origin
 ...
 L251:
	...
	-- AdjustOrigin: 3
	rpushg 3 origin
	rpushg 2 elsePart#S#171:origin
	rpushg 3 %if%then%%else%#S#166:origin
	rpushg 2 elsePart#S#165:origin
	rpushg 3 %if%then%%else%#S#156:origin
	rpushg 2 elsePart#S#155:origin
 ...
 L253:
	...
	-- AdjustOrigin: 3
	rpushg 3 origin
	rpushg 2 elsePart#S#174:origin
	rpushg 3 %if%then%%else%#S#169:origin
	rpushg 2 elsePart#S#168:origin
	rpushg 3 %if%then%%else%#S#159:origin
	rpushg 2 elsePart#S#158:origin
 ...
 L256:
	...
	-- on : 8
	-- AdjustOrigin: 0
	rpushg 2 thenPart#S#176:origin
	rpushg 3 %if%then%%else%#S#172:origin
	rpushg 2 elsePart#S#171:origin
	rpushg 3 %if%then%%else%#S#166:origin
	rpushg 2 elsePart#S#165:origin
	rpushg 3 %if%then%%else%#S#156:origin
 ...
 L258:
    ...
    mood := 0:IS-empty: staticOff: 0
	pushThis 
	invoke 178 0 %if%then%%else%#S#178
	rpop
 L259:
	rtnEventQ 0
	setThisStack 
 ...
 L260:
	...
	-- on : 8
	-- AdjustOrigin: 0
	rpushg 2 thenPart#S#179:origin
 ...
 L263:
	...
	class %if%then%%else%#S#178 178 3
	rstore 3 origin
	allocEventQ
	-- super %if%then%%else%
	--  1:36 2:36 3:0 4:0
	...
	-- AdjustOrigin: 3
	rpushg 3 origin
	rpushg 2 elsePart#S#177:origin
	rpushg 3 %if%then%%else%#S#172:origin
	rpushg 2 elsePart#S#171:origin
	rpushg 3 %if%then%%else%#S#166:origin
	rpushg 2 elsePart#S#165:origin
 ...
 L265:
	...
	-- AdjustOrigin: 3
	rpushg 3 origin
	rpushg 2 elsePart#S#180:origin
	rpushg 3 %if%then%%else%#S#175:origin
	rpushg 2 elsePart#S#174:origin
	rpushg 3 %if%then%%else%#S#169:origin
	rpushg 2 elsePart#S#168:origin
 ...
 L268:
	...
	-- on : 10
	-- AdjustOrigin: 0
	rpushg 2 thenPart#S#182:origin
	rpushg 3 %if%then%%else%#S#178:origin
	rpushg 2 elsePart#S#177:origin
	rpushg 3 %if%then%%else%#S#172:origin
	rpushg 2 elsePart#S#171:origin
	rpushg 3 %if%then%%else%#S#166:origin
 ...
 L270:
    ...
    mood := 0:IS-empty: staticOff: 0
	pushThis 
	invoke 184 0 %if%then%%else%#S#184
	rpop
 L271:
	rtnEventQ 0
	setThisStack 
 ...
 L275:
	...
	class %if%then%%else%#S#184 184 3
	rstore 3 origin
	allocEventQ
	-- super %if%then%%else%
	--  1:36 2:36 3:0 4:0
	...
	-- AdjustOrigin: 3
	rpushg 3 origin
	rpushg 2 elsePart#S#183:origin
	rpushg 3 %if%then%%else%#S#178:origin
	rpushg 2 elsePart#S#177:origin
	rpushg 3 %if%then%%else%#S#172:origin
	rpushg 2 elsePart#S#171:origin
 ...
 L281:
	...
	-- on : 12
	-- AdjustOrigin: 0
	rpushg 2 thenPart#S#187:origin
	rpushg 3 %if%then%%else%#S#184:origin
	rpushg 2 elsePart#S#183:origin
	rpushg 3 %if%then%%else%#S#178:origin
	rpushg 2 elsePart#S#177:origin
	rpushg 3 %if%then%%else%#S#172:origin
 ...
 L283:
	...
	-- on : 13
	-- AdjustOrigin: 0
	rpushg 2 elsePart#S#188:origin
	rpushg 3 %if%then%%else%#S#184:origin
	rpushg 2 elsePart#S#183:origin
	rpushg 3 %if%then%%else%#S#178:origin
	rpushg 2 elsePart#S#177:origin
 ...
 L287:
	...
	class EventProcessor 199 0
	stop

	class ThreadStub 200 0
	DO:
	mvStack 
	call(D)ThreadStub
	stop
	...
	-- vdtAdd: inx=2 descInx=158
	-- vdtAdd: inx=1 descInx=140
	-- vdtAdd: inx=1 descInx=141
	-- vdtAdd: inx=1 descInx=145
	-- vdtAdd: inx=1 descInx=151
	-- vdtAdd: inx=2 descInx=152
	-- vdtAdd: inx=1 descInx=164
	-- vdtAdd: inx=2 descInx=165
	-- vdtAdd: inx=1 descInx=167
	-- vdtAdd: inx=2 descInx=168
	-- vdtAdd: inx=1 descInx=149
	-- vdtAdd: inx=2 descInx=150
	-- vdtAdd: inx=1 descInx=170
	-- vdtAdd: inx=2 descInx=171
	-- vdtAdd: inx=1 descInx=173
	-- vdtAdd: inx=2 descInx=174
	-- vdtAdd: inx=1 descInx=176
	-- vdtAdd: inx=2 descInx=177
	-- vdtAdd: inx=1 descInx=179
	-- vdtAdd: inx=2 descInx=180
	-- vdtAdd: inx=1 descInx=182
	-- vdtAdd: inx=2 descInx=183
	-- vdtAdd: inx=1 descInx=185
	-- vdtAdd: inx=2 descInx=186
	-- vdtAdd: inx=1 descInx=187
	-- vdtAdd: inx=2 descInx=188
