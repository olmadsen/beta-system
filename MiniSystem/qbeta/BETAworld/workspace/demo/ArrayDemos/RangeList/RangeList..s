 ...
 L292:
	...
	-- pattern:gen: first -> r: ? Object
	-- pattern:gen: second -> r: ? Object
	-- pattern:gen: scan
 ...
 L298:
	-- Include:gen: 
	-- ObjectGenerator:gen: super: putint(ranges.head.low):IS-empty: staticOff: 0
	-- Invocation:gen: putint(ranges.head.low)
	-- Invocation:loadOrigin: putint(ranges.head.low)
	-- Invocation:loadOrigin:scan: putint(ranges.head.low)
	-- Function:pushThis: 
	pushThis 
	-- Function:loadOrigin: putint(ranges.head.low)
	-- AdjustOrigin: 0
	-- on : 4
	rpushg 1 origin
	rpushg 1 origin
	...
	rpushg 1 origin
	-- Function:loadArgs: 
	-- ObjectGenerator:gen: super: ranges.head.low:IS-empty: staticOff: 0
	-- Invocation:gen: ranges.head.low
	-- Invocation:loadOrigin: ranges.head.low
	...
	-- AdjustOrigin: 0
	-- on : 0
	-- next not assign: head :E: ranges
	-- Unary:loadArgs: 
	-- Unary:invoke: 
	-- VarRef:load: ranges
	rpushg 2 ranges
	-- Invocation:loadOrigin:scan: head
	-- next not assign: low :E: head
	-- Unary:loadArgs: 
	-- Unary:invoke: 
	-- VarRef:load: head
	rpushg 2 head
	...
	invoke 107 0 print
	rpop
	-- ObjectGenerator:gen: super: putint(ranges.head.upp):IS-empty: staticOff: 0
	-- Invocation:gen: putint(ranges.head.upp)
	-- Invocation:loadOrigin: putint(ranges.head.upp)
	-- Invocation:loadOrigin:scan: putint(ranges.head.upp)
	-- Function:pushThis: 
	pushThis 
	-- Function:loadOrigin: putint(ranges.head.upp)
	-- AdjustOrigin: 0
	-- on : 4
	rpushg 1 origin
	rpushg 1 origin
	...
	rpushg 1 origin
	-- Function:loadArgs: 
	-- ObjectGenerator:gen: super: ranges.head.upp:IS-empty: staticOff: 0
	-- Invocation:gen: ranges.head.upp
	-- Invocation:loadOrigin: ranges.head.upp
	-- Invocation:loadOrigin:scan: ranges
	-- Unary:pushThis: 
	pushThis 
	-- Unary:loadOrigin: ranges
	...
	invoke 66 0 newline
	rpop
	-- ObjectGenerator:gen: super: putint(ranges.tail.head.low):IS-empty: staticOff: 0
	-- Invocation:gen: putint(ranges.tail.head.low)
	-- Invocation:loadOrigin: putint(ranges.tail.head.low)
	-- Invocation:loadOrigin:scan: putint(ranges.tail.head.low)
	-- Function:pushThis: 
	pushThis 
	-- Function:loadOrigin: putint(ranges.tail.head.low)
	-- AdjustOrigin: 0
	-- on : 4
	rpushg 1 origin
	rpushg 1 origin
	...
	rpushg 1 origin
	-- Function:loadArgs: 
	-- ObjectGenerator:gen: super: ranges.tail.head.low:IS-empty: staticOff: 0
	-- Invocation:gen: ranges.tail.head.low
	-- Invocation:loadOrigin: ranges.tail.head.low
	-- Invocation:loadOrigin:scan: ranges
	-- Unary:pushThis: 
	pushThis 
	-- Unary:loadOrigin: ranges
	...
	invoke 107 0 print
	rpop
	-- ObjectGenerator:gen: super: putint(ranges.tail.head.upp):IS-empty: staticOff: 0
	-- Invocation:gen: putint(ranges.tail.head.upp)
	-- Invocation:loadOrigin: putint(ranges.tail.head.upp)
	-- Invocation:loadOrigin:scan: putint(ranges.tail.head.upp)
	-- Function:pushThis: 
	pushThis 
	-- Function:loadOrigin: putint(ranges.tail.head.upp)
	-- AdjustOrigin: 0
	-- on : 4
	rpushg 1 origin
	rpushg 1 origin
	...
	rpushg 1 origin
	-- Function:loadArgs: 
	-- ObjectGenerator:gen: super: ranges.tail.head.upp:IS-empty: staticOff: 0
	-- Invocation:gen: ranges.tail.head.upp
	-- Invocation:loadOrigin: ranges.tail.head.upp
	-- Invocation:loadOrigin:scan: ranges
	-- Unary:pushThis: 
	pushThis 
	-- Unary:loadOrigin: ranges
 ...
 L312:
    ...
    head := E:IS-empty: staticOff: 0
	pushThis 
	invoke 680 0 %if%then%%else%#S#680
	rpop
 L313:
	rtnEventQ 0
	setThisStack 
 ...
 L317:
    ...
    head := none:IS-empty: staticOff: 0
	pushThis 
	invoke 684 0 %if%then%%else%#S#684
	rpop
 L318:
	rtnEventQ 0
	setThisStack 
 ...
 L413:
    ...
    last := none:IS-empty: staticOff: 0
	pushThis 
	invoke 682 0 %if%then%%else%#S#682
	rpop
 L414:
	rtnEventQ 0
	setThisStack 
 ...
 L449:
	...
	class scan#S#449 449
	rstore 4 origin
	allocEventQ
	-- super scan
	--  1:0 2:0 3:0 4:0
	-- vdtAdd: inx=1 descInx=449
	-- Invocation:loadOrigin: scan
	-- Invocation:loadOrigin:scan: scan
	-- Unary:pushThis: 
	pushThis 
 ...
 L496:
	...
	pushThis 
	invoke 848 0 %if%then%%else%#S#848
	rpop
 L497:
	rtnEventQ 0
	setThisStack 
 ...
 L498:
    ...
    last := none:IS-empty: staticOff: 0
	pushThis 
	invoke 850 0 %if%then%%else%#S#850
	rpop
 L499:
	rtnEventQ 0
	setThisStack 
 ...
 L515:
	...
	class EventProcessor 875
	stop

	class ThreadStub 876
	DO:
	mvStack 
	call(D)ThreadStub
	stop
	-- vdtAdd: inx=1 descInx=675
	-- vdtAdd: inx=1 descInx=703
	-- vdtAdd: inx=2 descInx=704
	-- vdtAdd: inx=1 descInx=705
	-- vdtAdd: inx=2 descInx=706
	-- vdtAdd: inx=1 descInx=707
	-- vdtAdd: inx=2 descInx=708
	-- vdtAdd: inx=1 descInx=709
	-- vdtAdd: inx=2 descInx=710
	-- vdtAdd: inx=1 descInx=712
	-- vdtAdd: inx=1 descInx=687
	-- vdtAdd: inx=1 descInx=688
	-- vdtAdd: inx=1 descInx=718
	-- vdtAdd: inx=2 descInx=719
	-- vdtAdd: inx=1 descInx=720
	-- vdtAdd: inx=2 descInx=721
	-- vdtAdd: inx=1 descInx=685
	-- vdtAdd: inx=1 descInx=686
	-- vdtAdd: inx=1 descInx=690
	-- vdtAdd: inx=1 descInx=694
	-- vdtAdd: inx=2 descInx=695
	-- vdtAdd: inx=1 descInx=698
	-- vdtAdd: inx=2 descInx=699
	-- vdtAdd: inx=1 descInx=700
	-- vdtAdd: inx=2 descInx=701
	-- vdtAdd: inx=1 descInx=845
	-- vdtAdd: inx=2 descInx=846
	-- vdtAdd: inx=1 descInx=851
	-- vdtAdd: inx=2 descInx=852
	-- vdtAdd: inx=1 descInx=847
	-- vdtAdd: inx=2 descInx=849
	-- vdtAdd: inx=1 descInx=692
	-- vdtAdd: inx=2 descInx=693
	-- vdtAdd: inx=1 descInx=869
	-- vdtAdd: inx=2 descInx=870
	-- vdtAdd: inx=1 descInx=871
	-- vdtAdd: inx=2 descInx=872
...
Class %if%then%%else%#S#680 680 3
allocE:
1:	rstore 3
3:	allocEventQ 1
5:	pushthis 
...
Class %if%then%%else%#S#682 682 3
allocE:
1:	rstore 3
3:	allocEventQ 1
5:	pushthis 
...
Class %if%then%%else%#S#684 684 3
allocE:
1:	rstore 3
3:	allocEventQ 1
5:	pushthis 
...
Class %if%then%%else%#S#848 848 3
allocE:
1:	rstore 3
3:	allocEventQ 1
5:	pushthis 
...
Class %if%then%%else%#S#850 850 3
allocE:
1:	rstore 3
3:	allocEventQ 1
5:	pushthis 
...
Class EventProcessor 875 0
allocE:
1:	stop 


Class ThreadStub 876 0
allocE:
doE: 
1:	mvStack
2:	call D
