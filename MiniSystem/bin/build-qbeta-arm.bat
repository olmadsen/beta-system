...
echo "   "
arm-none-eabi-gcc -O0 -DRPI3 -mfpu=neon-vfpv4 -mfloat-abi=hard -march=armv8-a -mtune=cortex-a53 -nostartfiles -g -Wl,-T,%BL%/arm/rpi.x %1 %BL%/runbeta-arm.c %BL%/arm/qbeta-clib.c %BL%/arm/armc-uart.c  %BL%/arm/qbeta-slib.S %BL%/arm/init_mmu.S -o kernel.elf
