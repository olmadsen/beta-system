...
echo "------"
arm-none-eabi-gcc -O0 -DRPI3 -mfpu=neon-vfpv4 -mfloat-abi=hard -march=armv8-a -mtune=cortex-a53 -nostartfiles -g -Wl,-T,%BLA%/rpi.x %1 %BL%/runbeta-arm.c %BLA%/qbeta-clib.c  %BLA%/qbeta-slib.S %BLA%/init_mmu.S -o kernel.elf
