...
/* Static void symbwrite(long blst, long i, long *t) avs 16-9-96, bug? */
...
Local boolean testch(Char ch1, Char ch2, struct LOC_ingrammar *LINK)
{
  ...
  return ((LINK->chgroup[ch1] == LINK->chgroup[ch2] &&
	   LINK->chgroup[ch2] != sep) || (options[4] &&
					  LINK->chgroup[ch1] != sep &&
...
/* symbwrite(blst, WITH1->UU.U1.symb, &i5); avs 16-9-96 Looks like a bug */
